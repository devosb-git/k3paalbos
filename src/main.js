...
const icons = [
  ['🦊','Vosje'],['☀️','Zon'],['🌧️','Regen'],['☁️','Wolk'],['🌈','Regenboog'],['🌳','Buiten'],['🍎','Fruit'],['📚','Lezen'],['🎨','Knutselen'],['🎵','Muziek'],['🏃','Bewegen'],['🍽️','Eten'],['🚌','Bus'],['🎉','Feest']
