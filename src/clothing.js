...
function weekCards(){
  return weekDates.map((date,index)=>{
    ...
    const body=state?.gender
      ? `<img class="clothing-day-figure ${state.gender==='meisje'?'clothing-day-figure-girl':''}" src="${modelSrc(state.gender,state)}" alt="${state.gender==='meisje'?'Meisje':'Jongen'}">`
