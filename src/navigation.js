...
const labelToId={'Kalender':'calendar','Maandkalender':'calendar','Weekkalender':'week','Dagkalender':'day','Dagverloop':'day','Weer':'weather','Kleding':'clothing','Klastaken':'tasks'};
